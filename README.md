...
# Introduction to Fairness, Accountability, Transparency and Ethics (FATE) in Machine Learning

In this seminar, we will give a brief introduction to fairness, accountability, transparency and ethics in machine learning (FATE), motivated by the deployment of intelligent systems in almost all areas of society. We will focus on some examples of gender discrimination. We will conclude with a presentation of some technical solutions to certain cases of algorithmic discrimination, as well as their limitations, introducing the FairLearn tool.

The presentation [seminario-fate.md](seminario-fate.md) was created with [Marp](https://marp.app/) and exported to HTML.
